...
// Place this file at: venuewise.net/homehuddle/sw.js
// ═══════════════════════════════════════════════════════════════════
self.addEventListener('push', function(event) {
  ...
  const options = {
    ...
    data:    { url: data.url || 'https://venuewise.net/homehuddle/calendar.html' },
...
self.addEventListener('notificationclick', function(event) {
  ...
  const url = event.notification.data?.url || 'https://venuewise.net/homehuddle/calendar.html';
  event.waitUntil(
